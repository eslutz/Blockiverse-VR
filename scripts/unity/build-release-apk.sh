...
ANDROID_KEYSTORE_PASS="${ANDROID_KEYSTORE_PASS:-${ANDROID_KEYSTORE_PASSWORD:-}}"
ANDROID_KEYALIAS_NAME="${ANDROID_KEYALIAS_NAME:-${ANDROID_KEY_ALIAS:-}}"
ANDROID_KEYALIAS_PASS="${ANDROID_KEYALIAS_PASS:-${ANDROID_KEY_PASSWORD:-}}"
export ANDROID_KEYSTORE_PASS ANDROID_KEYALIAS_NAME ANDROID_KEYALIAS_PASS
