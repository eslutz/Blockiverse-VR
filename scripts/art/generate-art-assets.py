...
ATLAS_COLUMNS = 16
# 16x10 = 160 slots for 97 used. Mirrored by BlockVisualAtlas.Columns/Rows in C#.
#
# COLUMNS IS 16 SO A TILE INDEX IS ITS OWN COORDINATE IN HEX: index = row << 4 | column, so
# 0x63 is row 6, column 3. That is why the indices below are written as hex -- in decimal the
# same tile is 99, which reads as nothing and hides a wrong row.
#
# GROW BY ROWS, NEVER COLUMNS. Appending rows leaves every existing index and every existing
# pixel exactly where it was; changing COLUMNS reflows the whole atlas. Width is fixed at
# 16*48 = 768, so height may reach the importer's 1024 ceiling at 21 rows = 336 slots.
ATLAS_ROWS = 10
TILE_PIXELS = 32
...
BLOCKS = [
    ("meadow_turf", 0x00, (57, 134, 68), (151, 211, 83), "mottled", 11),
    ("loose_loam", 0x01, (105, 69, 44), (166, 111, 67), "grain", 23),
    ("graystone", 0x02, (91, 100, 112), (157, 167, 178), "strata", 37),
    ("branchwood_log", 0x03, (139, 90, 43), (215, 151, 76), "rings", 41),
    ("leafmoss", 0x04, (48, 125, 57), (106, 199, 74), "leaves", 53),
    ("lumen_quartz_cluster", 0x05, (72, 176, 208), (203, 242, 250), "crystal", 67),
    ("embercoal_seam", 0x06, (29, 30, 34), (86, 87, 98), "ore_bands", 71),
    ("rosycopper_bloom", 0x07, (92, 83, 74), (234, 125, 62), "ore_diagonal", 83),
    ("rustcore_ore", 0x08, (82, 87, 90), (215, 203, 176), "ore_cross", 97),
    ("build_table", 0x09, (144, 94, 48), (231, 183, 101), "grid", 101),
    ("glowwick", 0x0A, (61, 82, 49), (255, 191, 51), "glow", 109),
    ("storage_crate", 0x0B, (116, 77, 41), (205, 144, 70), "crate", 127),
    ("worldroot", 0x0C, (32, 35, 42), (89, 94, 105), "deep", 131),
    ("deepmantle", 0x0D, (43, 43, 52), (118, 116, 130), "strata", 137),
    ("dark_slate", 0x0E, (50, 58, 72), (117, 129, 146), "strata", 139),
    ("warm_granite", 0x0F, (118, 91, 76), (194, 151, 122), "speckles", 149),
    ("white_limestone", 0x10, (169, 169, 143), (229, 228, 195), "sediment", 151),
    ("black_basalt", 0x11, (34, 35, 39), (92, 86, 83), "column", 157),
    ("dry_turf", 0x12, (136, 112, 47), (215, 174, 71), "mottled", 163),
    ("snowcap_turf", 0x13, (98, 134, 124), (231, 242, 240), "snow", 167),
    ("rootsoil", 0x14, (72, 53, 37), (138, 93, 54), "roots", 173),
    ("claybed", 0x15, (133, 87, 66), (198, 130, 94), "grain", 179),
    ("river_silt", 0x16, (94, 91, 68), (156, 153, 109), "grain", 181),
    ("pale_sand", 0x17, (185, 169, 113), (238, 221, 157), "grain", 191),
    ("shingle_gravel", 0x18, (91, 88, 84), (158, 154, 147), "pebbles", 193),
    ("snowpack", 0x19, (177, 211, 221), (246, 251, 255), "snow", 197),
    ("frostglass", 0x1A, (78, 154, 184), (183, 232, 246), "glass", 199),
    ("thornbrush", 0x1B, (91, 76, 42), (169, 112, 57), "thorn", 211),
    ("reedgrass", 0x1C, (84, 128, 64), (176, 190, 85), "reeds", 223),
    ("work_plank", 0x1D, (132, 82, 42), (212, 145, 70), "planks", 227),
    ("cutstone_block", 0x1E, (100, 106, 112), (175, 181, 187), "brick", 229),
    ("fired_brick_block", 0x1F, (128, 58, 43), (208, 102, 65), "brick", 233),
    ("clearpane_glass", 0x20, (105, 188, 214), (220, 250, 255), "glass", 239),
    ("mirror_pane", 0x4D, (150, 162, 174), (236, 244, 250), "glass", 761),
    ("surface_pebbles", 0x21, (92, 87, 78), (181, 174, 151), "pebbles", 241),
    ("flinty_shingle", 0x22, (60, 67, 73), (187, 192, 186), "chips", 251),
    ("paletin_thread", 0x23, (79, 84, 89), (213, 196, 155), "ore_threads", 257),
    ("sunmetal_fleck", 0x24, (127, 81, 43), (255, 196, 74), "sparkle", 263),
    ("niterstone_pocket", 0x25, (95, 90, 82), (220, 214, 184), "speckles", 269),
    ("brightsalt_crust", 0x26, (164, 174, 164), (246, 246, 225), "crust", 271),
    ("shellgrit_bed", 0x27, (156, 139, 110), (229, 205, 171), "chips", 277),
    ("resin_knot", 0x28, (110, 72, 39), (230, 143, 50), "rings", 281),
    ("berrybush", 0x29, (50, 112, 54), (203, 56, 91), "berries_cluster", 283),
    ("grain_stalk", 0x2A, (119, 135, 54), (228, 196, 81), "grain_heads", 293),
    ("umbralite_node", 0x2B, (37, 32, 59), (117, 81, 181), "crystal", 307),
    ("staropal_geode", 0x2C, (45, 42, 70), (227, 196, 255), "crystal", 311),
    ("campfire", 0x2D, (112, 68, 42), (255, 132, 43), "flame", 313),
    ("clay_kiln", 0x2E, (120, 73, 56), (218, 124, 78), "kiln", 317),
    ("bellows_forge", 0x2F, (66, 68, 72), (235, 116, 57), "forge", 331),
    ("prep_board", 0x30, (143, 92, 50), (227, 178, 102), "grid", 337),
    ("mend_bench", 0x31, (104, 74, 52), (196, 165, 94), "tools", 347),
    ("lumen_lamp", 0x32, (53, 73, 76), (245, 236, 146), "lamp", 349),
    ("spark_flare", 0x33, (83, 52, 38), (255, 231, 97), "flare", 351),
    ("tended_soil", 0x34, (86, 61, 41), (138, 102, 64), "tilled", 353),
    ("grain_stalk_s1", 0x35, (106, 125, 57), (207, 181, 73), "crop_sprout", 359),
    ("grain_stalk_s2", 0x36, (112, 133, 58), (219, 190, 78), "crop_mid", 367),
    ("berrybush_s1", 0x37, (45, 99, 49), (135, 178, 74), "bush_sprout", 373),
    ("berrybush_s2", 0x38, (48, 109, 52), (185, 54, 86), "bush_mid", 379),
    ("reedgrass_s1", 0x39, (74, 116, 62), (151, 174, 82), "reed_sprout", 383),
    ("sapling", 0x3A, (93, 72, 44), (102, 175, 78), "sapling", 389),
    ("sapling_s1", 0x3B, (95, 74, 45), (113, 184, 82), "sapling_mid", 397),
    ("sapling_s2", 0x3C, (98, 77, 47), (122, 194, 88), "sapling_tall", 401),
    ("grain_stalk_s3", 0x3D, (119, 138, 58), (232, 200, 82), "crop_full", 409),
    ("grain_stalk_s4", 0x3E, (126, 143, 59), (244, 210, 89), "grain_heads", 419),
    ("berrybush_s3", 0x3F, (51, 118, 56), (205, 56, 91), "berries_cluster", 421),
    ("berrybush_s4", 0x40, (52, 124, 58), (219, 63, 98), "berries_cluster", 431),
    ("berrybush_s5", 0x41, (54, 132, 60), (236, 70, 107), "berries_cluster", 433),
    ("reedgrass_s2", 0x42, (80, 126, 64), (168, 186, 86), "reeds", 439),
    ("reedgrass_s3", 0x43, (84, 132, 66), (184, 198, 92), "reeds", 443),
    ("smooth_branchwood", 0x44, (138, 88, 43), (214, 149, 75), "smooth_planks", 449),
    ("reed_basket", 0x45, (126, 93, 48), (214, 178, 93), "basket", 457),
    ("tool_rack", 0x46, (96, 69, 47), (207, 185, 123), "rack", 461),
    ("pantry_jar", 0x47, (119, 81, 62), (224, 169, 111), "jar", 463),
    ("deep_locker", 0x48, (38, 41, 49), (124, 132, 148), "locker", 467),
    ("freshwater", 0x49, (38, 126, 182), (133, 218, 248), "fluid_water", 479),
    ("brine", 0x4A, (34, 111, 151), (164, 226, 226), "fluid_brine", 487),
    ("emberflow", 0x4B, (91, 38, 28), (255, 116, 44), "fluid_ember", 491),
    ("bedroll", 0x4C, (70, 88, 98), (219, 92, 83), "bedroll", 499),
    # Foliage pass: 78 existing slots plus these 19 tiles fill 97 of a 10x10 atlas.
    ("drygrass_tuft", 0x4E, (132, 111, 59), (213, 181, 94), "drygrass", 523),
    ("meadow_tuft", 0x4F, (64, 135, 66), (142, 207, 84), "meadow_grass", 541),
    ("wildflower_cluster", 0x50, (54, 120, 62), (242, 121, 132), "wildflowers", 547),
    ("dune_sage", 0x51, (111, 119, 76), (184, 191, 119), "sage", 557),
    ("salt_reed", 0x52, (86, 137, 111), (184, 216, 177), "salt_reeds", 563),
    ("frost_fern", 0x53, (94, 143, 133), (194, 235, 226), "fern", 569),
    ("windroot_shrub", 0x54, (88, 100, 66), (160, 178, 98), "shrub", 571),
    ("hanging_reed", 0x55, (72, 126, 78), (159, 194, 103), "hanging_reeds", 577),
    ("moss_carpet", 0x56, (54, 114, 58), (122, 178, 79), "moss_carpet", 587),
    ("snow_lichen", 0x57, (154, 181, 164), (235, 246, 231), "snow_lichen", 593),
    ("fallen_leaves", 0x58, (116, 76, 42), (202, 133, 62), "fallen_leaves", 599),
    ("charred_log", 0x59, (45, 43, 42), (106, 82, 61), "charred_wood", 601),
    ("snow_block", 0x5A, (176, 210, 221), (247, 252, 255), "snow", 607),
    ("meadow_turf_side", 0x5B, (105, 70, 45), (122, 184, 72), "meadow_turf_side", 613),
    ("dry_turf_side", 0x5C, (121, 82, 42), (196, 157, 63), "dry_turf_side", 617),
    ("snowcap_turf_side", 0x5D, (82, 94, 86), (235, 247, 245), "snowcap_turf_side", 619),
    ("rootsoil_side", 0x5E, (70, 51, 35), (148, 94, 53), "roots", 631),
    ("branchwood_log_end", 0x5F, (143, 91, 45), (220, 161, 82), "rings", 641),
    ("smooth_branchwood_end", 0x60, (145, 94, 49), (218, 158, 81), "rings", 643),
]
...
ITEMS = [
    ...
    ("mirror_pane", (150, 162, 174), (236, 244, 250), "block"),
