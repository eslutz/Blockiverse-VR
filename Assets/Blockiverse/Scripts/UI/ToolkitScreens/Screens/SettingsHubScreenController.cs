...
{
    // UI Toolkit port of the settings hub (uGUI: BlockiverseActionMenu on the settings panel,
    // voxel_survival_menus §6.19 adapted to the VR action-menu layout). The controller pushes
    ...
    public sealed class SettingsHubScreenController : UiToolkitScreenController, IUiToolkitActionMenuScreen
    {
        ...
        public override string ScreenId => MenuActions.SettingsScreen;
