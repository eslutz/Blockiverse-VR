...
{
    // UI Toolkit port of the pause menu (uGUI: BlockiverseActionMenu on "Pause Menu",
    // voxel_survival_menus §6.7). The controller pushes the title ("Paused") and the
    ...
    [UiToolkitScreen(MenuActions.PauseScreen, "Assets/Blockiverse/UI/Documents/PauseScreen.uxml",
        570, 814, UiToolkitPlacementProfile.Menu)]
        ...
        IUiToolkitActionMenuScreen, IUiToolkitStatusScreen
    {
        ...
        public override string ScreenId => MenuActions.PauseScreen;
