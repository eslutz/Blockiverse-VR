    ...
    public sealed class CreativeCatalog
    {
        ...
        public static CreativeCatalog CreateDefault(BlockRegistry blockRegistry = null)
        {
            ...
            var list = new List<CreativeCatalogEntry>
            {
                ...
                new(BlockRegistry.DrygrassTuft,      CreativeCatalogCategory.Foliage),
                new(BlockRegistry.MeadowTuft,        CreativeCatalogCategory.Foliage),
                new(BlockRegistry.WildflowerCluster, CreativeCatalogCategory.Foliage),
                new(BlockRegistry.DuneSage,          CreativeCatalogCategory.Foliage),
                new(BlockRegistry.SaltReed,          CreativeCatalogCategory.Foliage),
                new(BlockRegistry.FrostFern,         CreativeCatalogCategory.Foliage),
                new(BlockRegistry.WindrootShrub,     CreativeCatalogCategory.Foliage),
                new(BlockRegistry.HangingReed,       CreativeCatalogCategory.Foliage),
                new(BlockRegistry.MossCarpet,        CreativeCatalogCategory.Foliage),
                new(BlockRegistry.SnowLichen,        CreativeCatalogCategory.Foliage),
                new(BlockRegistry.FallenLeaves,      CreativeCatalogCategory.Foliage),
                new(BlockRegistry.CharredLog,        CreativeCatalogCategory.Foliage),
