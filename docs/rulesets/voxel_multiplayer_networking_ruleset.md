...
|---|---:|---:|---:|---:|---:|---:|---|
| `survival_terrain` | 192–512 | 256 | 192–512 | 16 | 6401 | 96 (sea level) | Ruleset-defined survival world with terrain, caves, fluids, resources, vegetation, environment hooks, and structures. Width/depth follow the world-size selector (small 192 / medium 256 / large 384 / x-large 512). |
| `flat_builder` | 192–512 | 64 | 192–512 | 16 | 1001 | 8 | Flat canonical creative world with the full creative catalog. |
